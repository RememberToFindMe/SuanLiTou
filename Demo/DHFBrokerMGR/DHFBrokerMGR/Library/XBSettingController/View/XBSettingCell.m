...
- (void)setupDetailText {
    ...
    self.detailLabel.textColor = COLOR_SUB_TITLE_TEXT;
...
- (void)setupFuncLabel
{
    ...
    self.funcNameLabel.textColor = COLOR_TITLE_TEXT;
...
{
    if (!_indicator) {
        _indicator = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"right_arrow_black"]];
